...
public class OnGUIlvl2 : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		//GUI.Label (new Rect (400, 20, 200, 50), "Caught Letters: " + caughtLetters.ToString ());
		GUI.Label (new Rect (300, 100, 200, 50), "LEVEL 2 TEMPORARY GUI ");
